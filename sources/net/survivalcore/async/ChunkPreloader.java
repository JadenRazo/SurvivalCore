...
public final class ChunkPreloader {
    ...
    // Chunks ahead to preload based on speed
    ...
    private ChunkPreloader(SurvivalCoreConfig config) {
        ...
        // enabled as part of async optimizations
        this.enabled = config.asyncEntityTrackerEnabled;
    }
    ...
    public List<long[]> getChunksToPreload(UUID playerId, double x, double z) {
        ...
        for (int distance = 1; distance <= PRELOAD_DISTANCE; distance++) {
